...
<div class="container">
  <div class="jumbotron bg-danger bg-gradient-secondary">
    <div class="container">
      ...
      Data science applied to identifying the bad actors 
      in the illicit sex and human trafficking trade which seem to be increasingly 
      operating from shadows of the spa industry.
      </p>
      <p class="lead text-white">           
      </p>
    </div>
...
<div class="container">
  <div class="row">
    <div class="col-md-12 align-self ">
      ...
      <p>
      Lorem ipsum dolor sit amet, vel ei malorum aliquid veritus, sed an nisl accusamus, 
...
<div class="container">
  <div class="row">
    <div class="col-md-4 align-self float-left">
      ...
      <p>
      Rubmaps.....olestiae vim. Ut amet tation vis, sit in dolore sapientem, elitr argumentum vim an.
      Summo abhorreant in his, ea habeo ullum conclusionemque sed. At per alii prompta, nominavi necessitatibus est ea.
      Lorem ipsum dolor sit amet, vel ei malorum aliquid veritus, sed an nisl accusamus, no duis molestiae 
      vim. Ut amet tation vis, sit in dolore sapientem, elitr argumentum vim an. Summo abhorreant in his, ea habeo ullum conclusionemque 
      sed. At per alii prompta, nominavi necessitatibus est ea.
    ...
    <div class="col-md-8 float-right" >
      <div class="">
        <a href="rub_reviews.php"  target="_blank"><img src="data_image/google_map.jpg"  alt="google_map" style="height:350px; width:100%"></a>
          <div class="caption">
            <p>Click on image to open interactive map.</p>
          </div>
      </div>
    </div>   <!-- end of col -->
  </div>   <!-- end of row -->
...
<div class="container">
  <div class="row">
    <div class="col-md-12 align-self ">
      <h5>The network and provider movement</h5>
      <p>
      Lorem ipsum dolor sit amet, vel ei malorum aliquid veritus, sed an nisl accusamus, 
      no duis molestiae vim. Ut amet tation vis, sit in dolore sapientem, elitr argumentum vim an.
      Summo abhorreant in his, ea habeo ullum conclusionemque sed. At per alii prompta, nominavi necessitatibus est ea.
...
<div class='container'>
  <div class="row">
    <div class="col-md-12" id="display" style="height: 600px; width: 100%;">
      <?php include('html_inclusions/moving_pieces.php'); ?>
    </div>
  </div>   <!-- end of row -->
</div>   <!-- end of container -->
...
<div class="container">
  <div class="row">
    <div class="col-md-12 align-self ">
      <h5>The men, and patterns of movement</h5>
      <p>
      Lorem ipsum dolor sit amet, vel ei malorum aliquid veritus, sed an nisl accusamus, 
      no duis molestiae vim. Ut amet tation vis, sit in dolore sapientem, elitr argumentum vim an.
      Summo abhorreant in his, ea habeo ullum conclusionemque sed. At per alii prompta, nominavi necessitatibus est ea.
...
<div class="container">
  <div class="row">
    <div class="col-md-5 align-self float-left">
      ...
      nominavi necessitatibus est ea <a href = "https://www.amtamassage.org/infocenter/economic_industry-fact-sheet.html">Massage statistics</a>
      </p>
    </div> 
    <div class="col-md-7 float-right">
...
<div class='container'>
  <div class="row">
    <div class="col-md-12 align-self float-left">
      ...
      Lorem ipsum dolor sit amet, vel ei malorum aliquid veritus, sed an nisl accusamus, no duis molestiae 
      vim. Ut amet tation vis, sit in dolore sapientem, elitr argumentum vim an. Summo abhorreant in his, ea habeo ullum conclusionemque 
      sed. At per alii prompta, nominavi necessitatibus est ea.  <a href = "https://www.amtamassage.org/infocenter/economic_industry-fact-sheet.html" target="_blank">Massage statistics</a>
      </p>
    </div>    <!-- end col -->
  </div>    <!-- end row -->
</div>    <!-- end container --> 
